...
summary: O comando start drive reconstruct inicia a reconstrução de uma unidade. 
---
= Inicie a reconstrução da condução
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
O `start drive reconstruct` comando inicia a reconstrução de uma unidade.
