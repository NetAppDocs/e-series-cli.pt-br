...
summary: O comando START drive Locate localiza uma unidade ligando uma luz indicadora na unidade. 
---
= Inicie a localização da unidade
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
O `start drive locate` comando localiza uma unidade ligando uma luz indicadora na unidade.
...
Execute o `stop drive locate` comando para desligar a luz indicadora na unidade.
