...
[role="lead"]
A lista a seguir de comandos de administrador está disponível para o sistema de storage e-Series.
...
link:../commands-a-z/show-storagearray-autosupport.html["Mostrar configuração do AutoSupport"]
